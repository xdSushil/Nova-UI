    ...
    return (
        <Card sx={{
            ...
            <CardContent sx={{ width: '100%' }}>
                ...
                {/* Location just to the right of the company name */}
                ...
                {/* Description just below the company name */}
                <Typography sx={{ position: 'absolute', top: '50%', left: 120, fontSize: '0.875rem', color: 'gray.300' }}>
                    Description: Leading manufacturer in heavy machinery production.
                </Typography>

                {/* Supplies below the description */}
                <Typography sx={{ position: 'absolute', bottom: '10%', left: 120, fontSize: '0.875rem', color: 'gray.300' }}>
                    Supplies: Machinery and Tools
                </Typography>
            </CardContent>
            ...
            <div className="absolute bottom-4 right-4">
                ...
                >
                    <motion.div
                        ...
                        initial={false}
                        animate={{ x: switchState === "stranger" ? 0 : switchState === "pending" ? 33 : 62 }}
